    ...
    public partial class InitialWith30 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ProductId = table.Column<int>(nullable: false),
                    CompareId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductCompare", x => new { x.ProductId, x.CompareId });
                    table.ForeignKey(
                        name: "FK_ProductCompare_Compare_CompareId",
                        column: x => x.CompareId,
                        principalTable: "Compare",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductCompare_Product_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Product",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductCompare_CompareId",
